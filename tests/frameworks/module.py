...
class _ImportHookChainedLoader:
    def __init__(self, loader: Loader | None, spec: ModuleSpec | None = None) -> None:
        self.loader = loader
        self.spec = spec
...
class BaseModuleWatchdog:
    ...
    _instance: BaseModuleWatchdog | None = None
    ...
    @classmethod
    def _find_in_meta_path(cls) -> int | None:
    ...
    def _remove_from_meta_path(cls) -> None:
        ...
        if i is None:
            raise RuntimeError(f"{cls.__name__} is not installed")
    ...
    def find_module(self, fullname: str, path: str | None = None) -> Loader | None:
    ...
    def install(cls) -> None:
        ...
        if cls.is_installed():
            raise RuntimeError(f"{cls.__name__} is already installed")
